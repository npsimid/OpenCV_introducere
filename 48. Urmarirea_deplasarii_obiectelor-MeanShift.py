...
while cap.isOpened():
    ...
    if ret:
        ...
        ret, fereastra_urmarire = cv.meanShift(destinatie, fereastra_urmarire, criterii_term)
        x, y, w, h = fereastra_urmarire
        imagine = cv.rectangle(frame, (x,y), (x+w, y+h), (0, 255, 0), 2)
